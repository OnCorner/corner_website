...
var Api = module.exports = {
  server: new Route(""),
  db: new Route(window.location.port == '4000' ? 'http://localhost:1337' : 'https://corner-backend-prod.herokuapp.com/'),
  // otherDb: new Route(chooseUrl("localhost")),
  // baseUrl: window.location.port == '4000' ? 'http://localhost:1337' : 'https://corner-backend-prod.herokuapp.com/',
}
